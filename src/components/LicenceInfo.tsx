...
export default function LicenceInfo() {
    ...
    return (
        <div className='bg-secondary rounded-md p-3'>
            <Descriptions column={1} contentStyle={{ justifyContent: "end", fontWeight: 700, fontSize: 14, color: colorText }} labelStyle={{ content: "" }} title="اطلاعات اشتراک">
                <Descriptions.Item label="تعداد جستوجو های مجاز">
                    1000
                </Descriptions.Item>
